...
//		public final FinalTest(final int a) {
//					//Illegal modifier for the constructor in type FinalTest; 
//					//only public, protected & private are permitted
...
//		}
		...
		public void assignment(final int a) {
			System.out.println(a);
			// a = 4;
		}
		/*static class Cat{
		...
		//final{//Syntax error, insert "enum Identifier" to complete EnumHeader
		      //语法错误，插入“enum标识符”以完成EnumHeader 
