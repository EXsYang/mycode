...
//    public ArrayList<Actor> testSelectToArrayList() {
        ...
        try {
            connection = JDBCUtilsByDruid.getConnection();
            System.out.println("直接打印:" + connection);//调的是toString(),com.mysql.jdbc.JDBC4Connection@2a2d45ba
            Class<? extends Connection> aClass = connection.getClass();
            System.out.println(aClass);//class com.alibaba.druid.pool.DruidPooledConnection
            System.out.println(connection.getClass());//运行类型 com.alibaba.druid.pool.DruidPooledConnection
            System.out.println(connection.getClass().toString());//class com.alibaba.druid.pool.DruidPooledConnection
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setInt(1, 1);//给?号赋值
            //执行, 得到结果集
            set = preparedStatement.executeQuery();
