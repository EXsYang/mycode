...
/**
 * @author yangda
 * @description: 我们自己编写一个一个极简的AOP类
 * @create 2023-09-07-18:53
 */
public class HspAOP {

    //我们一个方法,在目标对象执行前执行
    public static void before(Object proxy, Method method, Object[] args){
        //System.out.println("HspAOP-before-方法执行前-日志-方法名-" + method.getName() + "-参数 "
    ...
    public static void after(Method method,Object result){
        System.out.println("HspAOP-after-方法执行正常结束-日志-方法名-" + method.getName() + "-结果result= "
