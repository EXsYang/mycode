...
public class MyProxyProvider {
    ...
    //    System.out.println("同一个类中 before-方法执行前-日志-方法名-" + method.getName() + "-参数 "
    //            + Arrays.asList(args)); //这里从AOP看，就是一个横切关注点-前置通知
    //}
    //
    ////我们一个方法,在目标对象执行后执行
    //public void after(Method method, Object result) {
    //    System.out.println("同一个类中 after-方法执行正常结束-日志-方法名-" + method.getName() + "-结果result= "
    ...
    public SmartAnimalable getProxy() {
        ...
        InvocationHandler invocationHandler = new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                Object result = null;
                try {
                    //before(proxy,method,args);  // 耦合度高 在同一个类中
