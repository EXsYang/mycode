...
<%
    ...
    /*
    使用请求转发 在scope2.jsp获取数据的情况
    pageContext-k1: null
    request-k1: request数据(k1)
    session-k1: session数据(k1)
    application-k1: application数据(k1)*/
