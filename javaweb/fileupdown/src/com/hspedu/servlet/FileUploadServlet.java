            ...
            try {
                ...
                for (FileItem fileItem : list) {
                    ...
                    if (fileItem.isFormField()){//如果是true就是文本 input text
                        ...
                        //servletContext.getRealPath() 得到的是out工作目录的路径
                        String fileRealPath =
                        ...
                        File fileRealPathDirectory = new File(fileRealPath + WebUtils.getYearMonthDay()); //这里的斜杠被构造器拿掉了
