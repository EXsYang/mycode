package com.hspedu.servlet.servletconfig;
...
public class DBServlet1 extends HttpServlet {
    ...
    @Override
    public void init(ServletConfig config) throws ServletException {
        //多线程并发时，多个Servlet线程 同时 操作ServletContext 如何解决，使用ConcurrentHashMap集合
        //ConcurrentHashMap, 是一个线程安全的容器.
        super.init(config);
        System.out.println("DBServlet1  init config : " + config);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("DBServlet1  doPost servletConfig: " + servletConfig);
        String username = servletConfig.getInitParameter("username");
        String pwd = servletConfig.getInitParameter("pwd");
        System.out.println("DBServlet1  初始化参数username=" +username);
        System.out.println("DBServlet1  初始化参数pwd=" +pwd);
